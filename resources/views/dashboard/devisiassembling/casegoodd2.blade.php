...
@section('title', 'Dashboard Casegood D2 - Assembling')
@section('page-title', 'Dashboard Monitoring Casegood D2')
@section('content')
<style>
    .card-shadow {
...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-start mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Casegood D2 - Detail Produksi</h1>
    ...
    <div class="bg-white rounded-lg card-shadow p-4 mb-6">
        <div class="flex items-center mb-4">
            ...
            <span class="font-medium text-gray-700">Detail Work Center - Casegood D2</span>
                ...
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="flex items-center">
                            ...
                            <span class="font-medium">Casegood D2</span>
