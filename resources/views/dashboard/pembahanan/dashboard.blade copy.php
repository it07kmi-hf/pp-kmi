...
@section('title', 'Dashboard Pembahanan')
@section('page-title', 'Dashboard Pembahanan')

@section('content')
<div class="space-y-6">
    <!-- Welcome Card -->
    <div class="bg-white rounded-lg shadow p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Selamat Datang di Dashboard Pembahanan</h1>
        <p class="text-gray-600">Kelola proses pembahanan dan monitor aktivitas divisi Anda.</p>
    </div>
